...
CLASS zcl_rap100_gen_data_IA DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_IA IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'IA',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_ia_atrav.
*    DELETE FROM zrap100_ia_atrav.

    "insert travel demo data
    INSERT zrap100_ia_atrav  FROM (
        SELECT
